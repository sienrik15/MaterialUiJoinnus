package com.joinnus.utilities.materialui;
...
public class JoinnusBottomNavigationView extends BottomNavigationView {
    // used for animation
    ...
    public JoinnusBottomNavigationView(Context context) {
        super(context);
//        init();
    }

    public JoinnusBottomNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public JoinnusBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link JoinnusBottomNavigationView} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<JoinnusBottomNavigationView> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(JoinnusBottomNavigationView bnve) {
        ...
        public void onPageSelected(final int position) {
            final JoinnusBottomNavigationView bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, JoinnusBottomNavigationView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
